...
class Windows(Tk):
    ...
    def RegWin(self):
        ...
        self.reg.iconbitmap("logos/logo.ico")
        ...
        self.reg.bg_image = Image.open("logos/4.png")
        ...
        bg_Img.place(x=0, y=0, relheight=1, relwidth=1)
        # -------------------Row1
        self.reg.txt_1 = Image.open("logos/txtfield.png")
        ...
        txt_fname = Entry(self.reg, font=("times new roman", 15),bg = "#E9EDF5",bd=0).place(x=657, y=325, width=245, height=40)

        text_field2 = Label(self.reg, image=self.reg.txt1, bg="#0066CA", bd=0).place(x=1005, y=320, width=270, height=50)
        txt_lname = Entry(self.reg, font=("times new roman", 15),bg = "#E9EDF5",bd=0).place(x=1017, y=325, width=245, height=40)
        # -------------------Row2


        text_field3 = Label(self.reg, image=self.reg.txt1, bg="#0066CA", bd=0).place(x=1005, y=450, width=270, height=50)
        txt_contactno = Entry(self.reg, font=("times new roman", 15),bg="#E9EDF5",bd=0).place(x=1017, y=455, width=245, height=40)

        text_field4 = Label(self.reg, image=self.reg.txt1, bg="#0066CA", bd=0).place(x=1005, y=600, width=270,height=50)
        txt_email = Entry(self.reg, font=("times new roman", 15),bg="#E9EDF5",bd=0).place(x=1017, y=605, width=245, height=40)

        # -------------------Row3

        text_field5 = Label(self.reg, image=self.reg.txt1, bg="#0066CA", bd=0).place(x=645, y=450, width=270,height=50)
        txt_password = Entry(self.reg, font=("times new roman", 15),bg="#E9EDF5",bd=0).place(x=657, y=455, width=245, height=40)

        text_field6 = Label(self.reg, image=self.reg.txt1, bg="#0066CA", bd=0).place(x=645, y=600, width=270,height=50)
        txt_gender = Entry(self.reg, font=("times new roman", 15),bg="#E9EDF5",bd=0).place(x=657, y=605, width=245, height=40)
        ...
        self.reg.btn_register_img = Image.open("logos/register.png")
    ...
    def LogWin(self):
        ...
        self.log.iconbitmap("logos/logo.ico")
        ...
        self.log.txt_1 = Image.open("logos/txtfield.png")
